...
export function SettingsScreen({ onBack, onLogout, onSafetyCenter }: SettingsScreenProps) {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="border-b border-border">
          ...
          <button 
            ...
            className="w-full flex items-center justify-between px-4 py-4 hover:bg-muted transition-colors group"
          >
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-[#1B8A7B]/10">
                <Shield className="w-5 h-5 text-[#1B8A7B]" />
              </div>
              <div className="text-left">
                <div className="font-medium">Safety Center</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">
                  Emergency contacts & date safety
                </div>
              </div>
            </div>
